...
func (m *MockStore) CreateUser(ctx context.Context, arg bank.CreateUserParams) (bank.CreateUserRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", ctx, arg)
	ret0, _ := ret[0].(bank.CreateUserRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetUser(ctx context.Context, username string) (bank.GetUserRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUser", ctx, username)
	ret0, _ := ret[0].(bank.GetUserRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
